...
def generate_summary_report(
    ...
    output_file: str = "financing_costs_summary.xlsx",
):
    ...
    for app in applications:
        row = {
            ...
            # Validation
            "Validation Errors": "; ".join(app.validation_errors)
            if app.validation_errors
            else "",
            "Validation Warnings": "; ".join(app.validation_warnings)
    ...
    with pd.ExcelWriter(output_file, engine="openpyxl") as writer:
        ...
        for idx, col in enumerate(df.columns):
            ...
            worksheet.column_dimensions[get_column_letter(idx + 1)].width = min(
                max_length + 2, 50
            )
